...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 text-sm">Write and publish a new blog post.</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <form action="<?= base_url('admin/blogs/store') ?>" method="post" enctype="multipart/form-data" class="p-6 space-y-6">
            <?= csrf_field() ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring focus:ring-primary-200 transition duration-200 shadow-sm"
                        id="title" type="text" name="title" value="<?= old('title') ?>" placeholder="Enter blog title" required>
                </div>
                ...
                <div>
                    ...
                    <input class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring focus:ring-primary-200 transition duration-200 shadow-sm"
                        id="slug" type="text" name="slug" value="<?= old('slug') ?>" placeholder="enter-blog-slug" required>
                </div>
                ...
                <div>
                    ...
                    <input class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring focus:ring-primary-200 transition duration-200 shadow-sm"
                        id="author_name" type="text" name="author_name" value="<?= old('author_name') ?>" placeholder="Enter author name">
                </div>
