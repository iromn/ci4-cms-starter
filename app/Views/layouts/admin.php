...
<body class="bg-slate-50 font-sans text-gray-800 antialiased" x-data="{ sidebarOpen: false }">
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar -->
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 text-white transition-transform duration-300 ease-in-out lg:static lg:translate-x-0"
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                <a href="<?= base_url('admin/dashboard') ?>" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-200 <?= uri_string() == 'admin/dashboard' ? 'bg-primary-600 text-white shadow-md' : 'text-gray-400 hover:bg-gray-800 hover:text-white' ?>">
                ...
                <a href="<?= base_url('admin/users') ?>" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-200 <?= strpos(uri_string(), 'admin/users') === 0 ? 'bg-primary-600 text-white shadow-md' : 'text-gray-400 hover:bg-gray-800 hover:text-white' ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?= base_url('admin/blogs') ?>" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-200 <?= strpos(uri_string(), 'admin/blogs') === 0 ? 'bg-primary-600 text-white shadow-md' : 'text-gray-400 hover:bg-gray-800 hover:text-white' ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
